...
##个人笔记
程序的路由入口在permission.js
先加载permission.js再执行mian.js中的其他内容，从上往下解析，import中的内容会直接去解析import
的文件。

compants/breadcrumb 面包屑导航

compants/imageCropper 图像剪裁

ImageCropper:基于JavaScript的Web前端图片剪裁工具
