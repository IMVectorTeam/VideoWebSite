...
<body>
<h4>User</h4>
<a href="getUser?id=20154070">根据ID查询用户信息</a>
<a href="getUserByLikeName?name=张">根据用户名模糊查询用户</a>
...
<a href="getVideoListByCategoryName?name=电视">通过视频类别名称模糊查询视频</a>
<a href="getVideoListByUserId?id=20154070">根据用户id查询该用户的所有的上传的视频</a>
<a href="getVideoListByLikeName?name=未">根据视频名模糊查询</a>


<h4>Message</h4>
<a href="getMessageByVideoId?id=1002">按视频查询评论</a>
<a href="getAllMessage">查询所有评论</a>
<a href="getMessageByLikeContent?content=错">根据关键字模糊查询所有评论内容</a>
